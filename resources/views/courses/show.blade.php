        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm p-6 mb-6 lg:w-[65%]">
            <div class="flex flex-col sm:flex-row items-center gap-6">
                ...
                @elseif ($hasContactDetails)
                    @if ($branding->phone)
                        <a href="tel:{{ preg_replace('/\s+/', '', $branding->phone) }}" class="flex flex-col items-center text-center gap-10 shrink-0 sm:w-56 hover:opacity-80 transition">
                    ...
                    @else
                        <div class="flex flex-col items-center text-center gap-10 shrink-0 sm:w-56">
                            <img src="{{ asset('images/captain-phone.webp') }}" alt="Kapitän am Telefon" class="w-[12.5rem] h-[12.5rem] object-contain -scale-x-100">
