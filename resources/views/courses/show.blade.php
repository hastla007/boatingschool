        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm p-6 mb-6 lg:w-[65%]">
            <div class="flex flex-col sm:flex-row items-center gap-6">
                ...
                @elseif ($hasContactDetails)
                    @if ($branding->phone)
                        <a href="tel:{{ preg_replace('/\s+/', '', $branding->phone) }}" class="flex flex-col items-center text-center gap-10 shrink-0 sm:w-36 hover:opacity-80 transition">
                            <img src="{{ asset('images/captain-phone.webp') }}" alt="Kapitän am Telefon" class="w-20 h-20 object-contain" style="transform: scaleX(-1.7) scaleY(1.7)">
                            <span class="text-xs text-slate-500 dark:text-slate-400">Ruf uns einfach an!</span>
                        </a>
                    @else
                        <div class="flex flex-col items-center text-center gap-10 shrink-0 sm:w-36">
                            <img src="{{ asset('images/captain-phone.webp') }}" alt="Kapitän am Telefon" class="w-20 h-20 object-contain" style="transform: scaleX(-1.7) scaleY(1.7)">
