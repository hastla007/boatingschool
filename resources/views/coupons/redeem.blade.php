<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-slate-800 dark:text-slate-200">Code einlösen</h2>
    </x-slot>
    ...
    <div class="max-w-md mx-auto bg-white dark:bg-slate-800 rounded-2xl shadow-sm p-6">
        ...
        <h3 class="font-medium text-slate-800 dark:text-white mb-1">Gutschein-Code einlösen</h3>
        <p class="text-sm text-slate-500 mb-4">Hast du einen Kurs-Code von deiner Bootsschule erhalten? Gib ihn hier ein, um den Kurs freizuschalten.</p>
